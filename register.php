		...
		<div class="container">
			...
			if (isset($_POST['input'])) {
				...
				if (mysqli_num_rows($cek) == 0) {
					$insert = mysqli_query($koneksi, "INSERT INTO customer (kd_cus, nama, alamat, no_telp, username, password, gambar) VALUES ('$kd_cus', '$nama', '$alamat', '$no_telp', '$username', '$password', '../admin/gambar_customer/default.jpg')") or die(mysqli_error());
					if ($insert) {
			...
			<div class="table-responsive">
				...
				<div class="hero-unit">Harap isi form dibawah ini dengan lengkap dan benar sesuai idenditas anda!
					<p></p> Setelah form terisi selanjutnya Login sebagai Customer !
				</div>
