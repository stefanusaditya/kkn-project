	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Detail Barang</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					...
					<!--<div class="span4">-->
					<!--<div class="icons-box">-->
					<div class="hero-unit" style="margin-left: auto;">
						<table>
							<img src="admin/<?php echo $data['gambar']; ?>" style="border: 2px solid grey; border-radius: 5px;" width="500" height="300" />
							<tr>
								<td rowspan="7"></td>
							</tr>
							<tr>
                        ...
                        <td><h3>Satuan</h3></td>
                        <td><h3>:</h3></td>
                        <td><div><h3><?php //echo $data['br_satuan']; 
										?></h3></div></td>
                        </tr>-->
							<tr>
								<td></td>
							...
							<tr>
								...
								<td></td>
								<td>
									<div class="clear"> <a href="index.html" class="btn btn-lg btn-success">Beli</a></div>
								</td>
							</tr>
