                ...
                <section class="content">
	               ...
	               or username like '%$qcari%'  ";
                                            ...
                                            while ($data = mysqli_fetch_array($tampil)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center><a href="detail-admin.php?hal=edit&kd=<?php echo $data['user_id']; ?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data['fullname']; ?></a></center>
                                                        </td>
                                                        <!--<td><center><?php
                                                                        /**if($data['level'] == 'admin'){
								...
								echo '<span class="label label-info">User</span>';
                                                                        ...
                                                                        ?></center></td>-->
                                                        <!--<td><center><img src="<?php //echo $data['gambar']; 
                                                                                    ?>" class="img-circle" height="80" width="75" style="border: 3px solid #888;" /></center></td>-->
                                                        <td>
                                                            <center>
