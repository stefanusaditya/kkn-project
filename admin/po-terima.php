                                            ...
                                            while ($data = mysqli_fetch_array($tampil)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                <div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Pengiriman Order Selesai" href="input-po-kirim.php?hal=tambah&nopo=<?php echo $data['id']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span></a>
                                                                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Order" href="edit-po-terima.php?hal=edit&kode=<?php echo $data['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
