                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <select id="jenis" name="jenis" value="<?php echo $row['jenis']; ?>" class="form-control" required>
                                                        <option value="Makanan" <?php if ($row['jenis'] == "Kain Batikn") echo "selected"; ?>>Kain Batik</option>
                                                        <option value="Minuman" <?php if ($row['jenis'] == "Tudung Saji") echo "selected"; ?>>Tudung Saji</option>
                                                        <option value="Camilan" <?php if ($row['jenis'] == "Lainnya") echo "selected"; ?>>Lainnya</option>
                                                    </select>
