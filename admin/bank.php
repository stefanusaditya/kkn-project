                                        ...
                                        while ($data = mysqli_fetch_array($tampil)) {
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data['id_bank']; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data['nama_bank']; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data['no_rek']; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data['nasabah']; ?></center>
                                                    </td>
                                                    <td>
                                                        <center>
                                                            <div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Bank Account" href="edit-bank.php?hal=edit&kode=<?php echo $data['id_bank']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                                <a onclick="return confirm ('Yakin hapus <?php echo $data['nasabah']; ?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Bank Account" href="bank.php?hal=hapus&kd=<?php echo $data['id_bank']; ?>"><span class="glyphicon glyphicon-trash"></a>
                                                        </center>
                                                    </td>
                                                </tr>
                                </div>
