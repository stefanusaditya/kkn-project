                                            ...
                                            while ($data = mysqli_fetch_array($tampil)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                <div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Customer" href="edit-customer.php?hal=edit&kd_cus=<?php echo $data['kd_cus']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama']; ?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus customer" href="customer.php?hal=hapus&kd=<?php echo $data['kd_cus']; ?>"><span class="glyphicon glyphicon-trash"></a>
                                                            </center>
                                                        </td>
                                                    </tr>
                                    </div>
