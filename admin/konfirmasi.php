                                            ...
                                            while ($data = mysqli_fetch_array($tampil)) {
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center><?php echo $data['nopo']; ?></center>
                                                        </td>
                                                        <td>
                                                            <center><?php echo $data['kd_cus']; ?></center>
                                                        </td>
                                                        <td>
                                                            <center><?php echo $data['bayar_via']; ?></center>
                                                        </td>
                                                        <td>
                                                            <center><?php echo $data['tanggal']; ?></center>
                                                        </td>
                                                        <td>
                                                            <center>Rp. <?php echo number_format($data['jumlah'], 2, ",", "."); ?></center>
                                                        </td>
                                                        <td>
                                                            <center><?php
                                                        ...
                                                        <td>
                                                            <center>
                                                                <div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Detail Konfirmasi" href="detail-konfirmasi.php?hal=detail&kd=<?php echo $data['id_kon']; ?>"><span class="glyphicon glyphicon-search"></span></a>
                                                                    ...
                                                                    <a class="btn btn-sm btn-warning" data-placement="bottom" data-toggle="tooltip" title="Kirim Nota" href=""><span class="glyphicon glyphicon-envelope"></span></a>
                                                            </center>
                                                        </td>
                                                    </tr>
                                    </div>
