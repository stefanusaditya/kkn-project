		...
		<div class="container">
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>
						<center>Quatity</center>
					</th>
					<th>
						<center>Sub Total</center>
					</th>
					<th>
						<center>Quantity Option</center>
					</th>
				</tr>
				<?php
				...
				?>
						...
						<tr>
							...
							<td>
								<center><?php echo $data['size']; ?></center>
							</td>
							<td>
								<center><?php echo number_format($data['harga']); ?></center>
							</td>
							<td>
